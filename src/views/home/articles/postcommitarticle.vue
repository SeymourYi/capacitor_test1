<template>
  <div class="moments-container">
    ...
    <div class="original-post">
      ...
      <div class="post-content">{{ articleContent || '被评论的文章内容' }}</div>
    ...
    <div class="reply-section">
      <div class="reply-header">
        ...
        <div class="reply-info">
          <div class="reply-author">{{ userStore.userInfo ? userStore.userInfo.nickname : '我的昵称' }}</div>
          <div class="reply-meta">回复给 {{ articleAuthor || '原作者' }}</div>
        </div>
      </div>
...
const onPublish = () => {
  // 暂时只做UI，不实现具体逻辑
  console.log('发布评论:', content.value)
  console.log('评论的文章ID:', articleId.value)
}
